...
const LockedIcon = ({ active }: TIconProps) => {
  ...
  return (
    <Svg width={66} height={67} fill="none">
      <Path
        fill={active ? colors.gray[900] : colors.gray[300]}
      ...
      />
      <Path
        fill={active ? colors.blue[600] : colors.gray[400]}
      ...
      />
      <Path
        stroke={active ? colors.gray[900] : colors.gray[50]}
        strokeLinecap="round"
        strokeWidth={0.304}
